...
/**
 * @typedef {object} FileProcessorInput
 * @property {string} file
 * @typedef {object} FileProcessorOutput
 * @property {string} processor
 * @property {string} content
 * @property {Record<string, any>} meta
 * @callback FileProcessor
 * @param {FileProcessorInput} input
 * @returns {FileProcessorOutput | Promise<FileProcessorOutput>}
 */
 ...
 * @param {FileProcessor[]} options.processors
 * @returns {{ on: (input: FileSuccessHandler | FileErrorHandler | FolderFinishHandler) => void }}
 */
export const buildFileProcessor = (folder, { ignoreFile }) => {
